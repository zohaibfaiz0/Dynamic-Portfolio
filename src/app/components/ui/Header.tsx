...
const Header: React.FC = () => {
  ...
  return (
    <motion.header 
      ...
      className={`fixed top-0 left-0 right-0 z-50 py-4 xl:py-6  // Reduced padding
      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        <Link href="/">
          <motion.h1 
            ...
            whileTap={{ scale: 0.95 }}
            className="text-3xl font-bold relative group" // Reduced font size
          >
        ...
        {/* Desktop Navigation */}
        <div className="hidden xl:flex items-center gap-6"> {/* Reduced gap */}
          <Nav />
          <Link href="/contact" passHref>
            ...
            >
              <Button 
                className="h-10 px-6 bg-gradient-to-r from-emerald-500 via-[#00ff99] to-cyan-600 // Reduced height and padding
                  hover:bg-gradient-to-br hover:from-emerald-400 hover:via-[#00ff99]/90 hover:to-cyan-500 
                  text-white/90 hover:text-white
                  rounded-full text-md font-medium // Reduced font size
